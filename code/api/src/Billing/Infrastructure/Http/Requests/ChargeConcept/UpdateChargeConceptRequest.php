...
final class UpdateChargeConceptRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'tipo' => ['sometimes', 'required', 'string', 'in:administracion,fondo_imprevistos,multa,extraordinaria'],
            'metodo_calculo' => ['sometimes', 'required', 'string', 'in:coeficiente,fijo,por_area,manual'],
            'valor_base' => ['sometimes', 'required', 'numeric', 'min:0'],
        ];
    }
